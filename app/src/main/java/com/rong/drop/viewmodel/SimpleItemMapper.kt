...
import com.rong.drop.utils.TimeUtils
import java.util.*
...
object SimpleItemMapper {
    ...
    fun startDateMapper(): List<SimpleItemViewModel> {
        ...
        results.add(SimpleItemViewModel(TimeUtils.getTodayOfMonth().toString(), DropApplication.mCurrentActivity.getString(R.string.today)))
        (1..30).mapTo(results) {
