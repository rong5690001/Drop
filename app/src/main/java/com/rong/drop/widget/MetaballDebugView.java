...
public class MetaballDebugView extends View {
    ...
    public void setRadius(float radius) {
        ...
        if (circlePaths.size() == 0) {
            ...
            circlePaths.get(0).radius = radius;
        }
        invalidate();
    }
    ...
    public void setMetaballListener(MetaballListener metaballListener) {
        mMetaballListener = metaballListener;
    }
...
//        paint.setColor(0xff4db9ff);
    ...
    private void metaball(Canvas canvas, int j, int i, float v, float handle_len_rate, float maxDistance) {
        ...
        Log.d("Metaball", "angle1:" + angle1 + ",angle2:" + angle2 + ",angle1a:" + angle1a + ",angle1b:" + angle1b +
                ",angle2a:" + angle2a + ",angle2b:" + angle2b);
        ...
        Log.d("Metaball", "p1a:" + Arrays.toString(p1a) + ",p1b:" + Arrays.toString(p1b) + ",p2a:" + Arrays.toString
                (p2a) + ",p2b:" + Arrays.toString(p2b));
        ...
        Log.d("Metaball", "sp1:" + Arrays.toString(sp1) + ",sp2:" + Arrays.toString(sp2) + ",sp3:" + Arrays.toString
                (sp3) + ",sp4:" + Arrays.toString(sp4));
    ...
    public void setMetaballCenterX(float centerX) {
        circlePaths.get(0).center[0] = centerX;
        invalidate();
    }

    public void setMetaballCenterY(float centerY) {
        circlePaths.get(0).center[1] = centerY;
        invalidate();
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Circle circle0 = circlePaths.get(0);
        Circle circle1 = circlePaths.get(1);
        circle0.center[0] = event.getX();
        circle0.center[1] = event.getY();

        float d = getDistance(circle0.center, circle1.center);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (d < maxDistance) {
                    ...
                    circle0.center[0] = circle1.center[0];
                    circle0.center[1] = circle1.center[1];
                    invalidate();
                }
                break;
    ...
    private void startAnimation() {
        PropertyValuesHolder holder1 = PropertyValuesHolder.ofFloat("metaballCenterX"
                , circlePaths.get(0).center[0], circlePaths.get(1).center[0]);
        PropertyValuesHolder holder2 = PropertyValuesHolder.ofFloat("metaballCenterY"
                , circlePaths.get(0).center[1], circlePaths.get(1).center[1]);
        mValueAnimator = ObjectAnimator.ofPropertyValuesHolder(this, holder1, holder2);
    ...
    public interface MetaballListener {
        void onIncome();
